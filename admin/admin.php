    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="cetak_petugas.php">Laporan Petugas</a>
            <a class="collapse-item" href="cetak_masyarakat.php">Laporan Masyarakat </a>
            <a class="collapse-item" href="cetak_pengaduan.php">Laporan Pengaduan</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>auliaputri &copy; 2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
